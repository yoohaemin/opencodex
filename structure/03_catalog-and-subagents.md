...
- publishes GPT-5.6's proxy-backed Codex window as 600,000 nominal / 872,000 maximum with a 95%
  effective allowance (570,000 usable) and dynamic auto-compaction; fixed-window Claude/Grok compatibility exports
