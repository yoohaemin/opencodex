...
정확히 이 provider, endpoint, model id 조합만 고정된 Sol capability snapshot을 상속합니다. 컨텍스트 기본값은
272,000, 최대값은 872,000이며 자동 압축은 선택된 스레드 창에 위임됩니다. native reasoning ladder와 Codex tool metadata도 보존됩니다. 요청의
